...
function createContextMenu(actions) {
  ...
  return Menu.buildFromTemplate([
    ...
    { position: 4, label: "Show exercises", type: 'checkbox', checked: getShowExercises(), click: toggleShowExercises(updateContextMenu) },
    { position: 5, label: "Show exercise of the day", type: 'checkbox', checked: getShowExerciseOfDay(), click: toggleShowExerciseOfDay(updateContextMenu) },

    { type: 'separator' },
    { position: 7, label: 'Mute sound', type: 'checkbox', checked: !Boolean(getSoundVolumn()), click: toggleSoundVolume(updateContextMenu) },
