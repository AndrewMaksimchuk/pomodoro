...
import { getShowExerciseOfDay, setSettingProperty, getSettingProperty, } from "./settings.js";
...
export const downloadExerciseOfDay = async () => {
    ...
    try {
        ...
        if (undefined === name)
            return "ERROR";
        if (getSettingProperty("exerciseOfDay") === name &&
